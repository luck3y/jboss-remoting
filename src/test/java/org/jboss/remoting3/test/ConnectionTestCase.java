...
public class ConnectionTestCase {
    ...
    public void before() throws Exception {
        ...
        server = networkServerProvider.createServer(new InetSocketAddress("localhost", 30123), OptionMap.create(Options.SSL_STARTTLS, Boolean.FALSE), saslAuthenticationFactory, SSLContext.getDefault());
    }
